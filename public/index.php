...
class Knife_Customs {
    ...
    public static function inject_wizard() {
        ...
        $options = [
            ...
            'repeated' => __('Не испытывайте судьбу дважды. Задайте следующий вопрос оракулу позже, а пока воспользуйтесь гаданием на текстах. Нажмите на значок с перекрещенными стрелками справа от меню — откроется статья, внутри которой скрывается знак для вас.', 'knife-customs'),
        ];
