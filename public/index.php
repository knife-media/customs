...
class Knife_Customs {
    ...
    public static function inject_wizard() {
        ...
        $options = [
            ...
            'repeated' => __('Не испытывайте судьбу дважды. Задайте следующий вопрос оракулу завтра, а пока воспользуйтесь гаданием на текстах. Нажмите на кубики игральных костей справа от меню – откроется статья, внутри которой скрывается знак для вас.', 'knife-customs'),
        ];
