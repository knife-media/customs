...
add_action('the_content', function($content) {
    ...
    if(has_term($slug, 'special', $post) && is_main_query() && is_singular('post')) {
        $promo_link = sprintf(
            ...
            _x('Специальный проект', 'special: docmed', 'knife-customs'),
            _x('клиники доказательной медицины DocMed и журнала «НОЖ»', 'special: docmed', 'knife-customs')
        );
